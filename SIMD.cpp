...
namespace simd
{
    ...
    float_m256::float_m256() : data(_mm256_set1_ps(0.0f)) {}

    float_m256::float_m256(float value) : data(_mm256_set1_ps(value)) {}

    float_m256::float_m256(std::initializer_list<float> values) 
    {
        if (values.size() != 8)
    ...
    float_m256::float_m256(const __m256& ps) : data(ps) {}

    float_m256 float_m256::operator - () const
    {
    ...
    float_m256 float_m256::operator + (const float_m256& right) const
    {
    ...
    void float_m256::operator -= (const float_m256& right)
    {
    ...
    __m256 float_m256::operator < (const float_m256& right)
    {
    ...
    float float_m256::operator [] (int idx) const
    {
        return data[idx];
    }

    float& float_m256::operator [] (int idx)
    {
        return data[idx];
    }

    void float_m256::storeData(float* ptr) const
    {
